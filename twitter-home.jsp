...
<%
	...
	java.sql.Connection conn = null;
        ...
        /*get tweets*/
        java.sql.PreparedStatement ps1 = conn.prepareStatement("SELECT * FROM tweets_t WHERE user_id IN (SELECT target FROM follow_t WHERE stalkers=?)");
        ...
        <div class="row">
            ...
            <div class="span4" id="secondary">
                ...
                <div class="module other-side-content">
                	<!-- upload picture
                	<% String action = "\"upload-icon.jsp?key=" + key + "\"";
                	%>
                	<FORM  ENCTYPE="multipart/form-data" ACTION=<%=action%> METHOD=POST>
                    <br>
                    <center><b>Choose a profile picture to upload:</b>
                    <p>
                    <center><INPUT NAME="F1" TYPE="file">
                    <center><INPUT TYPE="submit" VALUE="Send File"></center>      
    				</FORM>
    				<br><br> -->
                    <!-- display 7 users im not following -->
                    <br><b><center>Follow new users:<center></b>
                    <div class="content">
                    <%
            ...
            <div class="span8 content-main">
                <div class="module">
					...
					for (int i = tweeterid.size()-1; i >=0; i--) {//for open
        				...
        				//link to their prof
        				String otherProfURL = "<a href=\"twitter-profile.jsp?key=" + key + "&user=" + tweeterid.get(i) + "\">";
        				...
        				//set-up hashtag link(s)
							...
							String retweetURL = "retweet-tweet.jsp?key="+ key + "&tweetid=" + tweetid.get(i);
                        ...
                        <div class="js-stream-item stream-item expanding-string-item">
                            <div class="tweet original-tweet">
                            	<div class="user-actions">
                                    <a class="btn follow-btn" href = <%=retweetURL%> >                             
                                ...
                                <div class="content">
                                    <div class="stream-item-header">
                                        ...
                                        <a class="account-group"><%=otherProfURL%>
